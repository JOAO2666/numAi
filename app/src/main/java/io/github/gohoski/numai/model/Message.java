...
public class Message {
    ...
    public void setMessageId(String value) {
        if (value != null && value.length() > 0) messageId = value;
    }
    ...
    public JSONObject toJSONObject() {
        ...
        if (generationId != null) json.put("generationId", generationId);
    ...
    public static Message fromJSONObject(JSONObject json) {
        ...
        message.setMessageId(json.getNullableString("messageId"));
        message.setChatId(json.getNullableString("chatId"));
        message.setGenerationId(json.getNullableString("generationId"));
